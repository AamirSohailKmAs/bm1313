    ...
    <div class="card">
      ...
      <form action="{{ route('roles.store') }}" method="POST">
        ...
        <div class="card-header">
          <div class="flex justify-center">
            <div>
              ...
              <x-input.default class="px-2" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Enter Role Name" required />
            </div>
          </div>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer">
          <x-button.default class="bg-blue-700 hover:bg-blue-500" type="submit" value="Save Role" />
